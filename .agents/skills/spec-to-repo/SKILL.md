...
7. **Draft Project Map** — Structure a `PROJECT_MAP.md` file that will serve as a global context anchor and navigation guide for AI coding assistants.
...
- **PROJECT_MAP.md (Context Engineering).** Generate a root file containing the complete file tree, core module responsibilities, database schema summary, and data flow. This is strictly designed to give AI assistants (Codex, Claude Code, etc.) immediate architectural context.
...
3. AI Navigation Map (`PROJECT_MAP.md`)
...
- [ ] `PROJECT_MAP.md` exists and accurately reflects the generated architecture
...
```
task-api/
├── PROJECT_MAP.md            # AI architecture and file tree navigation
├── README.md
...
- PROJECT_MAP.md exists and is non-empty
- .gitignore exists
