...
- `api.ts`: frontend-side request wrappers and TypeScript types that mirror backend contracts, including research-group, mentor, admin console, and daily learning contracts.
